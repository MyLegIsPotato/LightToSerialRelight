...
CRGB[16] rainbowColorBank = {CRGB::Red, CRGB::Blue, CRGB::Green, CRGB::Yellow,
...
void SetupBSPalettesRainbow(){
  CRGB selectedColor = rainbowColorBank[random(0,16)];
  primaryColorPalette = CRGBPalette16(selectedColor);
  secondaryColorPalette = CRGBPalette16(selectedColor);
}
